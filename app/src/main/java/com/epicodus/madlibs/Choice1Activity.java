...
public class Choice1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == mCreateButton) {
            ...
            Intent intent = new Intent(Choice1Activity.this, Story1Activity.class);
